...
medical       & Claude~4.6  & $0.254$ & $0.190$ & $0.229$ & $0.250$ & $4$ & flat (near-saturated) \\
...
\bottomrule
\multicolumn{8}{l}{\footnotesize medical/Claude/1-agent and logic/GPT-4o/4-agent re-run from a contaminated/partial earlier collection; full $5{,}000$ and $1{,}500$ items respectively.}\\
\end{tabular}
\end{table}
